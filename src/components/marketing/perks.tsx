        ...
        <div id="perks" className="flex flex-col items-center justify-center py-12 md:py-16 lg:py-24 w-full">
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <SectionBadge title="Perks of Plugging In" />
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Unlock faster growth with smarter data
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        MarketMiner gives you the kind of intelligence agencies usually dig weeks for — delivered, simplified, and ready to act on.
                    </p>
                </div>
            </Container>
            <Container>
