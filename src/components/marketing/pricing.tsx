    ...
    return (
        <div id="pricing" className="flex flex-col items-center justify-center py-12 md:py-16 lg:py-24  w-full relative">
            ...
            <div className="mt-8 w-full relative flex flex-col items-center justify-center">
                ...
                <div className="absolute hidden lg:block top-1/2 left-2/3 -translate-x-1/4 -translate-y-1/2 w-96 h-96 bg-violet-500/15 blur-[10rem] -z-10"></div>
                <Container>
                    <Tabs defaultValue="oneTime" className="w-full flex flex-col items-center justify-center">
                        <TabsList>
...
const Plan = ({
    ...
    const getDisplayedPrice = (plan: string, monthlyPrice: number, oneTimePrice: number) => {
        if (plan === "monthly") {
            return monthlyPrice === 0 ? 0 : monthlyPrice;
        } else if (plan === "oneTime") {
            return oneTimePrice === 0 ? 0 : oneTimePrice;
        }
        return 0;
    };

    const displayedPrice = getDisplayedPrice(plan, monthlyPrice, oneTimePrice);
    const currentFeatures = plan === "monthly" ? monthlyFeatures : oneTimeFeatures;
