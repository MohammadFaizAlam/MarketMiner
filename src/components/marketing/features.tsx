        ...
        <div id="features" className="flex flex-col items-center justify-center py-12 md:py-16 lg:py-24 w-full">
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <SectionBadge title="What’s Inside" />
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Intelligence assets built to<br /> grow your agency faster.
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Every MarketMiner drop is packed with data-rich, ready-to-use intelligence designed to boost your performance and save you hours.
                    </p>
                </div>
            </Container>
                                ...
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Reverse-engineered ad creatives, angles & funnels from top competitors — decoded and annotated.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                            ...
                            <MagicCard particles={true} className="flex flex-col items-start w-full row-span-1 bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        <h4 className="text-xl font-heading font-medium heading">
                                            Lead Lists (By Niche + Intent)
                                        </h4>
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Pre-verified, high-conversion lead lists for real estate, local SEO, service businesses, and more.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                                    ...
                                    <div className="bento-card w-full relative items-center justify-center">
                                        <div className="w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                                            <p className="text-base text-muted-foreground text-justify [mask-image:radial-gradient(50%_50%_at_50%_50%,#BAB3FF_0%,rgba(186,179,255,0)_90.69%)]">
                                                ad breakdowns B2B lead lists digital marketing data market research for agencies competitor intelligence curated prospecting templates
                                            </p>
                                        </div>
                            ...
                            <MagicCard particles={true} className="flex flex-col items-start w-full row-span-1 bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    <div className="flex flex-col mb-auto">
                                        <h4 className="text-xl font-heading font-medium heading ">
                                            Market Insights Sheets
                                        </h4>
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Curated trend data, competitor moves, keyword gaps & strategy plays — no digging required.
                                        </p>
                                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-[.40fr_1fr] w-full gap-5 lg:gap-5">
                            <MagicCard particles={true} className="flex flex-col items-start w-full bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        <h4 className="text-xl font-heading font-medium heading ">
                                            Campaign Hook Libraries
                                        </h4>
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Battle-tested copy angles & headlines extracted from winning ad sets across niches.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                            <MagicCard particles={true} className="flex flex-col items-start w-full bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            All assets come in Google Sheets, Notion-ready tables, and Airtable format — no setup needed.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
